...
<div class="row g-4 mb-4">
    <div class="col-12 d-flex justify-content-between align-items-center">
        <div>
            <h4 class="fw-bold text-dark mb-1">Product Sub Category - Edit</h4>
        </div>
    </div>
</div>
    ...
    <div class="col-lg-8">
        <div class="card">
            <div class="card-header bg-soft-secondary d-flex justify-content-between align-items-center">
                <h5 class="card-title mb-0">Product Sub Category - Edit</h5>
                <div class="float-end">
                    <button type="submit" form="editSubCategoryForm" class="btn btn-primary btn-sm me-1">
            ...
            <div class="card-body">
                ...
                @endif
                <form id="editSubCategoryForm" action="{{ route('product-sub-categories.update', $subCategory->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-9">
                            <select class="form-select" id="item_category_id" name="item_category_id">
                                ...
                                @foreach($categories as $cat)
                                    <option value="{{ $cat->id }}" {{ old('item_category_id', $subCategory->item_category_id) == $cat->id ? 'selected' : '' }}>
