...
<div class="row g-4 mb-4">
    <div class="col-12 d-flex justify-content-between align-items-center">
        <div>
            <h4 class="fw-bold text-dark mb-1">GRN Returns</h4>
            <p class="text-muted small mb-0">List of recorded GRN returns</p>
        </div>
        <a href="{{ route('grn-returns.create') }}" class="btn btn-primary btn-sm rounded-pill"><i class="ri-add-line me-1"></i>New GRN Return</a>
    </div>
</div>
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="text-center py-5 text-muted">No GRN returns found.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
