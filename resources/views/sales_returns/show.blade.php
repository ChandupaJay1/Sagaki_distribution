...
@section('title', 'Sales Return - View Details')

@section('content')
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">Sales Return Details</h4>
            <div class="page-title-right">
                <a href="{{ route('sales-returns.index') }}" class="btn btn-secondary btn-sm"><i class="ri-arrow-left-line me-1"></i>Back to List</a>
                <a href="{{ route('sales-returns.edit', $return->id) }}" class="btn btn-primary btn-sm"><i class="ri-pencil-line me-1"></i>Edit Return</a>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="card-body">
                <div class="row mb-4">
                    <div class="col-sm-6">
                        ...
                        <p class="fw-bold mb-1">{{ $return->customer->company_name ?? $return->customer->name }}</p>
