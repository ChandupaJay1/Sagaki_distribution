    ...
    <div class="col-12">
        <div class="d-flex align-items-center justify-content-between">
            <div>
                ...
                <p class="text-muted small mb-0">Manage generic categories independent from customer categories.</p>
            </div>
    ...
    <div class="col-lg-12">
        <div class="card border-0 shadow-sm" style="border-radius: 16px;">
            <div class="card-header bg-transparent border-0 pt-4 px-4 d-flex align-items-center justify-content-between">
                <h5 class="card-title mb-0 fw-bold text-dark">Categories</h5>
                <div class="flex-shrink-0">
                    <a href="{{ route('categories.create') }}" class="btn btn-primary btn-sm px-3 rounded-pill fw-bold shadow-sm">
                                ...
                                <tr>
                                    ...
                                    <td class="pe-4 text-end">
                                        <div class="d-flex justify-content-end gap-2">
                                            <a href="{{ route('categories.edit', $category->id) }}" class="btn btn-sm btn-light border-0 rounded-circle text-primary" title="Edit">
                                ...
                                <tr>
                                    <td colspan="5" class="text-center py-5">
                                        <div class="text-muted">
                                            ...
                                            <p class="mt-2 mb-0">No categories created yet.</p>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
