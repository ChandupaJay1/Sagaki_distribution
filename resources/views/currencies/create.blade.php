...
<div class="row g-4 mb-4">
    <div class="col-12 d-flex justify-content-between align-items-center">
        <div>
            <h4 class="fw-bold text-dark mb-1">Currency - Create</h4>
        </div>
    </div>
</div>
    ...
    <div class="col-lg-8">
        <div class="card">
            <div class="card-header bg-soft-secondary d-flex justify-content-between align-items-center">
                <h5 class="card-title mb-0">Currency - Create</h5>
                <div class="float-end">
                    <button type="reset" form="createCurrencyForm" class="btn btn-dark btn-sm me-1">
                        <i class="ri-refresh-line align-middle me-1"></i> Reset
                    </button>
                    <button type="submit" form="createCurrencyForm" class="btn btn-danger btn-sm me-1">
            ...
            <div class="card-body">
                ...
                @endif
                <form id="createCurrencyForm" action="{{ route('currencies.store') }}" method="POST">
                    @csrf
                    <div class="mb-3 row">
