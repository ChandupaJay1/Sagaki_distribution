...
<div class="row g-4 mb-4">
    <div class="col-12 d-flex justify-content-between align-items-center">
        <div>
            <h4 class="fw-bold text-dark mb-1">Terms - Create</h4>
        </div>
    </div>
</div>
    ...
    <div class="col-lg-8">
        <div class="card">
            <div class="card-header bg-soft-secondary d-flex justify-content-between align-items-center">
                <h5 class="card-title mb-0">Terms - Create</h5>
                <div class="float-end">
                    <button type="reset" form="createTermsForm" class="btn btn-dark btn-sm me-1">
                        <i class="ri-refresh-line align-middle me-1"></i> Reset
                    </button>
                    <button type="submit" form="createTermsForm" class="btn btn-danger btn-sm me-1">
            ...
            <div class="card-body">
                ...
                @endif
                <form id="createTermsForm" action="{{ route('terms.store') }}" method="POST">
                    @csrf
                    <div class="mb-3 row">
                        <label for="days" class="col-sm-3 col-form-label fw-bold">Days <span class="text-danger">*</span></label>
                        <div class="col-sm-4">
                            <input type="number" class="form-control" id="days" name="days" value="{{ old('days') }}" min="0" required>
                        </div>
                    </div>
