...
<div class="row g-4 mb-4">
    <div class="col-12 d-flex justify-content-between align-items-center">
        <div>
            <h4 class="fw-bold text-dark mb-1">Supplier Categories</h4>
            <p class="text-muted small mb-0">Group suppliers into categories</p>
        </div>
        <a href="{{ route('supplier-categories.create') }}" class="btn btn-primary btn-sm rounded-pill"><i class="ri-add-line me-1"></i>Add Category</a>
    </div>
    </div>
            ...
            <table class="table table-hover align-middle mb-0">
                <thead class="bg-light">
                    <tr>
                        ...
                        <th class="text-muted small fw-bold text-uppercase">Category Name</th>
                ...
                <tbody>
                        ...
                        <tr>
                            ...
                            <td class="pe-4 text-end">
                                <div class="d-flex justify-content-end gap-2">
                                    <a href="{{ route('supplier-categories.edit', $category->id) }}" class="btn btn-sm btn-light border-0 rounded-circle text-primary" title="Edit">
                                        <i class="ri-edit-2-line fs-16"></i>
                                    </a>
                                    <form action="{{ route('supplier-categories.destroy', $category->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Delete this supplier category?');">
                                        @csrf
                                        @method('DELETE')
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="text-center py-5 text-muted">No supplier categories found.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
