...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">Sales Order Details</h4>
            <div class="page-title-right">
                <a href="{{ route('sales-orders.index') }}" class="btn btn-secondary btn-sm"><i class="ri-arrow-left-line me-1"></i>Back to List</a>
                <a href="{{ route('sales-orders.edit', $order->id) }}" class="btn btn-primary btn-sm"><i class="ri-pencil-line me-1"></i>Edit Order</a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header bg-soft-info py-2">
                <h5 class="card-title mb-0">Order Information: {{ $order->reference_no ?? 'No Reference' }}</h5>
            </div>
            <div class="card-body">
                <div class="row mb-4">
                    <div class="col-sm-4">
                        <h6 class="text-muted text-uppercase fw-semibold mb-2">Customer Details</h6>
                        <p class="fw-bold mb-1">{{ $order->customer->company_name ?? $order->customer->name }}</p>
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="d-flex justify-content-between mb-1">
                            ...
                            <span class="fw-medium">{{ $order->expected_date }}</span>
                        </div>
                        <div class="d-flex justify-content-between mb-1">
                    ...
                    <div class="col-sm-4">
                        <h6 class="text-muted text-uppercase fw-semibold mb-2">Personnel & Terms</h6>
                        <div class="d-flex justify-content-between mb-1">
                            <span class="text-muted">Rep:</span>
                            <span class="fw-medium">{{ $order->rep->name ?? '—' }}</span>
                        </div>
                        <div class="d-flex justify-content-between mb-1">
                            <span class="text-muted">Terms:</span>
                            <span class="fw-medium">{{ $order->terms }} Days</span>
                        </div>
                        <div class="d-flex justify-content-between mb-1">
                            <span class="text-muted">Due Date:</span>
                            <span class="fw-medium">{{ $order->due_date }}</span>
                        </div>
                    </div>
                </div>
