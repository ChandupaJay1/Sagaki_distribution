...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">Item Category - Create</h4>
    ...
    <div class="col-lg-8">
        <div class="card">
            <div class="card-header bg-soft-secondary d-flex justify-content-between align-items-center">
                <h5 class="card-title mb-0">Item Category - Create</h5>
                <div class="float-end">
                    <button type="reset" form="createItemCategoryForm" class="btn btn-dark btn-sm me-1">
                        <i class="ri-refresh-line align-middle me-1"></i> Reset
                    </button>
                    <button type="submit" form="createItemCategoryForm" class="btn btn-danger btn-sm me-1">
            ...
            <div class="card-body">
                ...
                <form id="createItemCategoryForm" action="{{ route('item-categories.store') }}" method="POST">
                    @csrf
