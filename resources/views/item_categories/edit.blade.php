...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">Item Category - Edit</h4>

            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('master-tables') }}">Master Tables</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('item-categories.index') }}">Item Categories</a></li>
    ...
    <div class="col-lg-8">
        <div class="card">
            <div class="card-header bg-soft-secondary d-flex justify-content-between align-items-center">
                <h5 class="card-title mb-0">Item Category - Edit</h5>
                <div class="float-end">
                    <button type="reset" form="editItemCategoryForm" class="btn btn-dark btn-sm me-1">
                        <i class="ri-refresh-line align-middle me-1"></i> Reset
                    </button>
                    <button type="submit" form="editItemCategoryForm" class="btn btn-danger btn-sm me-1">
                        <i class="ri-save-3-line align-middle me-1"></i> Update
                    </button>
                    <a href="{{ route('item-categories.index') }}" class="btn btn-success btn-sm">
            ...
            <div class="card-body">
                ...
                <form id="editItemCategoryForm" action="{{ route('item-categories.update', $itemCategory->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="code" name="code" value="{{ old('code', $itemCategory->code) }}" placeholder="e.g. CAT01">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row align-items-center">
                        ...
                        <div class="col-sm-9">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1" {{ old('is_active', $itemCategory->is_active) ? 'checked' : '' }} style="width: 3em; height: 1.5em;">
