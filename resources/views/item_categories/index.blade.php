...
<div class="row g-4 mb-4">
    <div class="col-12">
        <div class="d-flex align-items-center justify-content-between">
            <div>
                <h4 class="fw-bold text-dark mb-1">Item Categories</h4>
                <p class="text-muted small mb-0">Organize your items into logical groups.</p>
            </div>
    ...
    <div class="col-lg-12">
        <div class="card border-0 shadow-sm" style="border-radius: 16px;">
            <div class="card-header bg-transparent border-0 pt-4 px-4 d-flex align-items-center justify-content-between">
                <h5 class="card-title mb-0 fw-bold text-dark">Item Categories</h5>
                <div class="flex-shrink-0">
                    <a href="{{ route('item-categories.create') }}" class="btn btn-primary btn-sm px-3 rounded-pill fw-bold shadow-sm">
                                ...
                                <tr>
                                    ...
                                    <td class="pe-4 text-end">
                                        <div class="d-flex justify-content-end gap-2">
                                            <a href="{{ route('item-categories.edit', $category->id) }}" class="btn btn-sm btn-light border-0 rounded-circle text-primary" title="Edit">
                                                <i class="ri-edit-2-line fs-16"></i>
                                            </a>
                                            <form action="{{ route('item-categories.destroy', $category->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this category?');">
                                                @csrf
                                                @method('DELETE')
                                ...
                                <tr>
                                    <td colspan="5" class="text-center py-5">
                                        <div class="text-muted">
                                            ...
                                            <p class="mt-2 mb-0">No item categories created yet.</p>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
